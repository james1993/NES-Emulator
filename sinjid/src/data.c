...
/* 2*/ { "Silver Knife", ITEM_WEAPON, 140, 1, 10, 0,0, 10,0, 0,0, 0,0,0,0, 0, WEAP_KNIFE, P_STEEL,
        "Cheap steel, honestly made." },
/* 3*/ { "Long Sword", ITEM_WEAPON, 190, 2, 15, 0,0, 12,0, 0,0, 0,0,0,2, 0, WEAP_BROAD, P_STEEL,
        "A working blade." },
/* 4*/ { "Spiked Axe", ITEM_WEAPON, 200, 2, 16, 0,0, 11,0, 0,0, 0,0,0,5, 0, WEAP_AXE, P_STEEL2,
        "A working blade." },
/* 5*/ { "Heavy Blade", ITEM_WEAPON, 230, 2, 16, 0,0, 16,0, 0,0, 0,0,0,0, 0, WEAP_BROAD, P_STEEL,
        "A working blade." },
/* 6*/ { "Katana", ITEM_WEAPON, 400, 3, 18, 0,0, 24,0, 0,0, 0,0,0,7, 0, WEAP_KATANA, P_STEEL,
        "A working blade." },
/* 7*/ { "Shield Breaker", ITEM_WEAPON, 560, 4, 22, 0,0, 17,0, 0,0, 0,0,0,40, 0, WEAP_BROAD, P_STEEL,
        "Made for taking guards apart." },
/* 8*/ { "Blaze Edge", ITEM_WEAPON, 520, 4, 23, 0,0, 20,0, 13,0, 0,0,0,5, 0, WEAP_KATANA, P_BLOOD2,
        "A working blade." },
/* 9*/ { "Fusion Edge", ITEM_WEAPON, 710, 4, 25, 0,20, 24,0, 18,0, 0,0,0,5, 0, WEAP_KATANA, P_KI,
...
/*16*/ { "Double Razor", ITEM_WEAPON, 360, 3, 18, 0,0, 13,0, 8,0, 0,0,0,7, 0, WEAP_KATANA, P_STEEL,
        "A working blade." },
/*17*/ { "Shadow Katana", ITEM_WEAPON, 1300, 4, 24, 0,0, 33,0, 32,0, 0,0,0,10, 15, WEAP_KATANA, P_VIOLET,
        "A working blade." },
/*18*/ { "Shadow Spirit", ITEM_WEAPON, 1230, 3, 19, 0,80, 21,0, 44,0, 0,0,0,5, 0, WEAP_BROAD, P_VIOLET,
        "Channels more ki than steel." },
/*19*/ { "Fallen Blade", ITEM_WEAPON, 1490, 5, 40, 0,0, 75,15, 10,0, 0,0,0,0, 0, WEAP_BROAD, P_VIOLET,
        "Heavy to lift, worse to be hit by." },
/*20*/ { "Wooden Rod", ITEM_WEAPON, 400, 2, 15, 0,30, 5,0, 16,0, 0,0,0,0, 0, WEAP_STAFF, P_BARK,
        "Channels more ki than steel." },
/*21*/ { "Golden Rod", ITEM_WEAPON, 780, 2, 15, 0,60, 7,0, 34,0, 0,0,0,0, 0, WEAP_STAFF, P_GOLD,
        "Channels more ki than steel." },
/*22*/ { "Wooden Staff", ITEM_WEAPON, 900, 2, 15, 0,100, 10,0, 30,0, 0,0,0,0, 0, WEAP_STAFF, P_BARK,
        "Channels more ki than steel." },
/*23*/ { "Ion Bo", ITEM_WEAPON, 1390, 3, 20, 0,120, 10,0, 60,0, 0,0,0,0, 0, WEAP_STAFF, P_KI,
        "Channels more ki than steel." },
/*24*/ { "Rust Blade", ITEM_WEAPON, 260, 2, 15, 0,0, 18,0, 0,0, 0,0,0,0, 0, WEAP_BROAD, P_GOLD2,
        "A working blade." },
/*25*/ { "Leather Wrist", ITEM_SHIELD, 140, 1, 5, 0,0, 0,0, 0,0, 25,10,0,0, 0, SHLD_WRIST, P_BARK,
        "Barely more than a wrapped arm." },
/*26*/ { "Metal Wrist", ITEM_SHIELD, 260, 1, 5, 0,0, 0,0, 0,0, 40,20,0,0, 0, SHLD_WRIST, P_STEEL,
        "Barely more than a wrapped arm." },
/*27*/ { "Wooden Guard", ITEM_SHIELD, 260, 2, 15, 0,0, 0,0, 0,0, 50,15,0,0, 0, SHLD_BUCKLER, P_BARK,
        "Honest cover." },
/*28*/ { "Hand Blade", ITEM_SHIELD, 510, 3, 17, 0,0, 0,0, 0,0, 60,50,0,0, 0, SHLD_BLADE, P_STEEL,
        "Honest cover." },
/*29*/ { "Metal Guard", ITEM_SHIELD, 480, 3, 18, 0,0, 0,0, 0,0, 80,35,0,0, 0, SHLD_BUCKLER, P_STEEL,
        "Honest cover." },
/*30*/ { "Double Blade", ITEM_SHIELD, 750, 3, 19, 0,0, 0,0, 0,0, 75,80,0,0, 0, SHLD_BLADE, P_STEEL,
        "Honest cover." },
...
/*35*/ { "Claw Blade", ITEM_SHIELD, 860, 4, 23, 0,0, 0,0, 0,0, 100,85,0,0, 0, SHLD_BLADE, P_STEEL,
        "Honest cover." },
/*36*/ { "Shadow Wrist", ITEM_SHIELD, 1060, 2, 16, 0,0, 0,0, 0,0, 100,40,60,0, 5, SHLD_WRIST, P_VIOLET,
        "Turns spellwork better than steel." },
/*37*/ { "Energy Wrist", ITEM_SHIELD, 1120, 3, 18, 0,30, 0,0, 0,0, 120,20,80,0, 0, SHLD_WRIST, P_KI,
        "Turns spellwork better than steel." },
/*38*/ { "The Guardian", ITEM_SHIELD, 1600, 4, 25, 0,0, 0,0, 0,0, 300,50,50,0, 0, SHLD_BUCKLER, P_GOLD,
        "A wall you happen to carry." },
/*39*/ { "Blade Shield", ITEM_SHIELD, 1180, 4, 24, 0,0, 0,0, 0,0, 170,70,30,0, 0, SHLD_BLADE, P_STEEL,
        "Honest cover." },
/*40*/ { "Fallen Shield", ITEM_SHIELD, 1440, 4, 24, 0,0, 0,0, 0,0, 250,70,30,0, 0, SHLD_TOWER, P_VIOLET,
        "A wall you happen to carry." },
/*41*/ { "Voodoo Shield", ITEM_SHIELD, 1100, 3, 18, 0,40, 0,0, 0,0, 120,0,92,0, 0, SHLD_KITE, P_JADE,
        "Turns spellwork better than steel." },
/*42*/ { "Bandana", ITEM_HELM, 210, 1, 1, 0,0, 0,7, 0,5, 0,0,0,0, 0, HELM_BANDANA, P_STEEL,
        "Keeps sweat out of your eyes." },
/*43*/ { "Metal Band", ITEM_HELM, 320, 1, 10, 0,0, 0,15, 0,3, 0,0,0,0, 0, HELM_CIRCLET, P_STEEL,
        "Dented, and still worth wearing." },
/*44*/ { "Focus Band", ITEM_HELM, 400, 1, 10, 0,30, 0,5, 0,12, 0,0,0,0, 0, HELM_HOOD, P_KI2,
        "Narrows the world to one point." },
/*45*/ { "Fire Band", ITEM_HELM, 310, 2, 15, 0,0, 0,6, 7,6, 0,0,0,0, 0, HELM_CIRCLET, P_BLOOD2,
        "Keeps sweat out of your eyes." },
/*46*/ { "Power Band", ITEM_HELM, 450, 3, 17, 0,0, 13,12, 0,3, 0,0,0,0, 0, HELM_CIRCLET, P_STEEL,
        "Keeps sweat out of your eyes." },
/*47*/ { "Golden Band", ITEM_HELM, 620, 3, 18, 0,0, 0,20, 0,15, 0,0,0,0, 0, HELM_CIRCLET, P_GOLD,
        "Dented, and still worth wearing." },
/*48*/ { "Demon Skin", ITEM_HELM, 730, 4, 22, 0,0, 8,15, 12,10, 0,0,0,0, 0, HELM_HOOD, P_BLOOD,
        "Dented, and still worth wearing." },
/*49*/ { "Shadow Band", ITEM_HELM, 510, 3, 19, 0,20, 0,10, 0,10, 0,0,0,0, 5, HELM_CIRCLET, P_VIOLET,
        "Keeps sweat out of your eyes." },
/*50*/ { "Snake Band", ITEM_HELM, 150, 2, 15, 0,10, 0,0, 0,0, 0,0,0,0, 6, HELM_CIRCLET, P_JADE,
        "Keeps sweat out of your eyes." },
/*51*/ { "Ki Band", ITEM_HELM, 730, 2, 15, 0,50, 0,15, 15,5, 0,0,0,0, 0, HELM_CIRCLET, P_KI,
        "Narrows the world to one point." },
/*52*/ { "Leather Armour", ITEM_ARMOUR, 530, 2, 13, 0,0, 0,20, 0,10, 0,0,0,0, 0, 0, P_BARK,
        "Layered cloth and patience." },
/*53*/ { "Metal Plates", ITEM_ARMOUR, 790, 3, 19, 0,0, 0,30, 0,15, 0,0,0,0, 0, 0, P_STEEL,
        "Layered cloth and patience." },
/*54*/ { "Metal Armour", ITEM_ARMOUR, 1060, 3, 21, 0,0, 0,40, 0,20, 0,0,0,0, 0, 0, P_STEEL,
        "Layered cloth and patience." },
/*55*/ { "Golden Armour", ITEM_ARMOUR, 2110, 3, 20, 0,0, 0,60, 0,60, 0,0,0,0, 0, 0, P_GOLD,
        "Plated, and heavy with it." },
/*56*/ { "Demon Rags", ITEM_ARMOUR, 1360, 5, 28, 0,0, 15,50, 0,15, 0,0,0,0, 0, 0, P_BLOOD,
        "Plated, and heavy with it." },
/*57*/ { "Focus Armour", ITEM_ARMOUR, 1260, 3, 17, 0,100, 0,15, 10,30, 0,0,0,0, 0, 0, P_KI2,
        "Woven against the shadow, not the sword." },
/*58*/ { "Snake Skin", ITEM_ARMOUR, 840, 2, 15, 0,15, 0,10, 6,30, 0,0,0,0, 0, 0, P_JADE,
        "Woven against the shadow, not the sword." },
/*59*/ { "Shadow Armour", ITEM_ARMOUR, 1750, 4, 22, 0,0, 0,35, 0,50, 0,0,0,0, 13, 0, P_VIOLET,
        "Woven against the shadow, not the sword." },
