...
const SkillDef SKILLS[MAX_SKILLS] = {
 { "Stab", "A short thrust inside the guard. Cheap, quick, and it lands.",
   0, 10, 0, { -1, -1 }, 15, 0,  95, 6, 0, 0, 0, 0,
   DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_NONE, ANIM_ATTACK, P_STEEL },
 { "Shurikens", "A handful of thrown blades. They find the guard rather than the man.",
   0, 10, 0, { -1, -1 }, 20, 0,  100, 0, 0, 0, 62, 8,
   DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_NEVER_MISS, ANIM_ATTACK, P_GOLD },
 { "Double Strike", "Two cuts in the time most fighters manage one.",
   0, 10, 0, { -1, -1 }, 20, 0,  52, 8, 0, 0, 0, 0,
   DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_NONE, ANIM_ATTACK, P_STEEL },
 { "Speed Strike", "Fast enough that the guard never comes up. Cannot miss.",
   0, 10, 0, { -1, -1 }, 20, 0,   45, 5, 0, 0, 0, 0,
   DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_NEVER_MISS, ANIM_ATTACK, P_STEEL },
 { "Energy Shot", "A thrown coal of ki. Pure magic -- it ignores shields entirely.",
   1, 10, 0, { 1, -1 }, 25, 0,   100, 0, 40, 9, 0, 0,
   DMG_MAGIC, SK_TARGET_ONE_FOE, SKF_PURE_MAGIC, ANIM_CAST, P_BLOOD2 },
 { "Blast Fire", "Fire off the palm. Pure magic, and it goes straight through a shield.",
   1, 10, 0, { 1, -1 }, 25, 0,   100, 0, 7, 5, 0, 0,
   DMG_MAGIC, SK_TARGET_ONE_FOE, SKF_PURE_MAGIC, ANIM_CAST, P_KI },
 { "Vertical Strike", "An overhead cut brought straight down through the guard.",
   0, 10, 1, { 2, -1 }, 20, 0,  105, 7, 0, 0, 0, 0,
   DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_NONE, ANIM_ATTACK, P_STEEL },
 { "Shadow Blend", "Passive. You are harder to read, and harder to hit clean.",
   0, 10, 1, { 3, -1 }, 0, 0,   0, 0, 0, 4, 0, 0,
   DMG_PHYSICAL, SK_TARGET_SELF, SKF_PASSIVE, ANIM_STAND, P_STEEL },
 { "Energy Field", "Passive. Breath discipline that deepens the damage your spells do.",
   1, 10, 1, { 4, -1 }, 0, 0,    0, 0, 0, 7, 0, 0,
   DMG_MAGIC, SK_TARGET_SELF, SKF_PASSIVE, ANIM_STAND, P_KI },
 { "Charge", "Gather yourself. Costs nothing but the turn, and the next blows come harder.",
   1, 10, 1, { 4, -1 }, 0, 0,   0, 0, 0, 0, 0, 0,
   DMG_PHYSICAL, SK_TARGET_SELF, SKF_BUFF_DEF, ANIM_HEAL, P_GOLD },
 { "Inner Strength", "Passive. The edge finds the seam by itself now.",
   0, 10, 5, { 6, -1 }, 0, 0,    0, 0, 0, 5, 0, 0,
   DMG_PHYSICAL, SK_TARGET_SELF, SKF_PASSIVE, ANIM_STAND, P_STEEL },
 { "Mana Bomb", "A spike of cold driven past the guard. Pure magic.",
   1, 10, 5, { 8, -1 }, 1, 0,   70, 7, 0, 0, 0, 0,
   DMG_MAGIC, SK_TARGET_ONE_FOE, SKF_PURE_MAGIC | SKF_IGNORE_SHD, ANIM_CAST, P_KI2 },
 { "Heal", "Close your own wounds with ki instead of thread.",
   1, 10, 5, { 9, -1 }, 15, 0,   0, 0, 80, 22, 0, 0,
   DMG_MAGIC, SK_TARGET_SELF, SKF_HEAL, ANIM_HEAL, P_JADE },
 { "Avenger", "The nearer death you are, the harder it lands.",
   0, 10, 10, { 10, -1 }, 25, 0, 60, 4, 0, 0, 0, 0,
   DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_MISSING_LIFE, ANIM_ATTACK, P_BLOOD },
 { "Split", "Cuts away a share of whatever life is still standing in front of you.",
   0, 10, 10, { 10, -1 }, 25, 0, 10, 2, 0, 0, 0, 0,
   DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_TARGET_LIFE, ANIM_ATTACK, P_BLOOD2 },
 { "Shadow Strike", "Splits across the whole line and never misses one of them.",
   1, 10, 10, { 7, 11 }, 40, 0,  55, 6, 0, 0, 0, 0,
   DMG_MAGIC, SK_TARGET_ALL_FOES, SKF_PURE_MAGIC | SKF_NEVER_MISS, ANIM_CAST, P_KI2 },
 { "Annihilate", "Pull the life across the gap and keep half of what comes.",
   1, 10, 10, { 5, 12 }, 60, 0,  60, 6, 0, 0, 0, 0,
   DMG_MAGIC, SK_TARGET_ONE_FOE, SKF_DRAIN | SKF_IGNORE_SHD, ANIM_CAST, P_VIOLET },
 { "Execution", "Everything you have, in one downward cut.",
   0, 10, 15, { 13, 14 }, 70, 0, 60, 5, 0, 0, 0, 0,
   DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_NEVER_MISS, ANIM_ATTACK, P_BLOOD2 },
 { "Shadow Replicate", "Tears the shape out from under them. Nothing blunts it.",
   1, 10, 15, { 15, -1 }, 100, 0, 90, 8, 0, 0, 0, 0,
   DMG_MAGIC, SK_TARGET_ONE_FOE, SKF_PURE_MAGIC | SKF_IGNORE_SHD | SKF_NEVER_MISS, ANIM_CAST, P_VIOLET },
};
...
const EnemyDef ENEMIES[] = {
 { "Bandit", 40, 7,0,5, 15,10, 60,20,0, 0,15, 30,40, 28,1,
   { {178,142,110,255},{92,74,60,255},{62,50,40,255},{160,70,54,255},{38,30,26,255},P_STEEL,
     BODY_HUMAN, WEAP_KNIFE, SHLD_NONE, HELM_BANDANA, P_STEEL, P_STEEL, 1.02f, false, 0 }, {2,2},2 },
 { "Thief", 60, 5,0,5, 15,10, 20,20,0, 0,15, 30,30, 28,1,
   { {186,150,116,255},{106,84,66,255},{72,56,44,255},{150,60,50,255},{40,32,28,255},P_STEEL,
     BODY_HUMAN, WEAP_KNIFE, SHLD_NONE, HELM_BANDANA, P_STEEL, P_STEEL, 1.0f, false, 0 }, {2,2},2 },
 { "Training Ward", 80, 5,5,100, 0,50, 300,50,0, 0,15, 0,0, 28,1,
   { {150,120,80,255},{120,96,64,255},{88,68,44,255},{170,150,110,255},{90,70,50,255},P_STEEL,
     BODY_HUMAN, WEAP_NONE, SHLD_NONE, HELM_NONE, P_STEEL, P_STEEL, 0.95f, false, 0 }, {2,3,5},3 },
 ...
 { "Assailant", 100, 14,0,10, 30,5, 40,15,15, 0,50, 60,90, 28,1,
   { {172,140,112,255},{54,56,70,255},{34,36,46,255},{150,52,48,255},{30,28,26,255},P_INK2,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_HOOD, P_INK2, P_INK2, 1.0f, false, 0 }, {2,2},2 },
 ...
 { "Raider", 120, 9,0,5, 15,10, 15,20,0, 0,15, 40,50, 28,1,
   { {182,146,112,255},{104,80,52,255},{70,54,36,255},{170,120,60,255},{44,34,28,255},P_STEEL,
     BODY_HUMAN, WEAP_BROAD, SHLD_NONE, HELM_BANDANA, P_STEEL, P_STEEL, 1.03f, false, 0 }, {2,2},2 },
 ...
 { "Warrior", 180, 8,0,10, 15,10, 200,20,0, 0,15, 40,60, 36,2,
   { {190,156,120,255},{86,86,96,255},{56,56,64,255},{160,140,90,255},{36,30,28,255},P_STEEL,
     BODY_HUMAN, WEAP_BROAD, SHLD_NONE, HELM_FULL, P_STEEL, P_STEEL, 1.05f, false, 0 }, {2,2},2 },
 { "Assailant", 180, 23,0,20, 40,15, 0,40,15, 0,60, 120,120, 36,2,
   { {172,140,112,255},{54,56,70,255},{34,36,46,255},{150,52,48,255},{30,28,26,255},P_INK2,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_HOOD, P_INK2, P_INK2, 1.0f, false, 0 }, {2,3,5},3 },
 ...
 { "Seer", 200, 2,8,10, 10,30, 170,15,60, 0,17, 40,70, 36,2,
   { {198,180,160,255},{74,66,104,255},{48,42,70,255},{150,130,190,255},{60,50,44,255},P_VIOLET,
     BODY_HUMAN, WEAP_STAFF, SHLD_NONE, HELM_HOOD, P_VIOLET, P_VIOLET, 1.0f, false, 0 }, {2,13,11,15},4 },
 ...
 { "Skeleton", 400, 14,10,10, 10,10, 0,10,10, 0,25, 300,450, 36,2,
   { {206,200,182,255},{96,96,90,255},{60,60,56,255},{150,148,136,255},{30,30,30,255},P_STEEL2,
     BODY_UNDEAD, WEAP_AXE, SHLD_NONE, HELM_NONE, P_STEEL2, P_STEEL2, 1.0f, false, 0 }, {2,2,3},3 },
 { "Mercenary", 400, 12,0,10, 20,20, 150,70,70, 0,14, 60,80, 36,2,
   { {178,140,108,255},{92,70,58,255},{60,46,38,255},{170,120,60,255},{50,40,34,255},P_STEEL2,
     BODY_HUMAN, WEAP_BROAD, SHLD_NONE, HELM_HORNED, P_STEEL2, P_STEEL2, 1.1f, false, 0 }, {2,2,3},3 },
 { "Skeleton Mage", 400, 0,32,0, 10,30, 800,20,60, 0,22, 200,260, 36,2,
   { {198,192,172,255},{70,60,92,255},{46,40,62,255},{140,120,180,255},{30,30,30,255},P_VIOLET,
     BODY_UNDEAD, WEAP_NONE, SHLD_NONE, HELM_HOOD, P_VIOLET, P_VIOLET, 1.0f, true, 0 }, {2,13,11,15},4 },
 { "Mercenary", 420, 10,0,15, 30,0, 170,30,0, 0,10, 150,260, 36,2,
   { {178,140,108,255},{92,70,58,255},{60,46,38,255},{170,120,60,255},{50,40,34,255},P_STEEL2,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_HORNED, P_STEEL2, P_STEEL2, 1.1f, false, 0 }, {2,2,3},3 },
 { "Skeleton", 450, 17,5,10, 20,20, 350,20,20, 0,27, 350,450, 44,3,
   { {206,200,182,255},{96,96,90,255},{60,60,56,255},{150,148,136,255},{30,30,30,255},P_STEEL2,
     BODY_UNDEAD, WEAP_BROAD, SHLD_NONE, HELM_NONE, P_STEEL2, P_STEEL2, 1.0f, false, 0 }, {2,2,3},3 },
 ...
 { "Agent", 550, 17,0,15, 40,-15, 250,50,25, 0,19, 150,160, 44,3,
   { {168,138,112,255},{40,42,54,255},{26,28,36,255},{140,44,44,255},{28,26,24,255},P_INK2,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_HOOD, P_INK2, P_INK2, 1.0f, false, 0 }, {2,2,3},3 },
 { "Poison Wasp", 550, 16,0,5, 15,10, 1,10,10, 0,35, 170,250, 44,3,
   { {168,150,60,255},{120,104,40,255},{84,72,28,255},{208,190,90,255},{60,52,24,255},P_STEEL,
     BODY_BEAST, WEAP_NONE, SHLD_NONE, HELM_NONE, P_STEEL, P_STEEL, 0.72f, false, 0 }, {2,2,3},3 },
 ...
 { "Shaman", 700, 7,14,7, 40,40, 1,0,0, 0,19, 200,70, 44,3,
   { {176,150,120,255},{86,70,52,255},{56,46,34,255},{120,160,110,255},{40,34,28,255},P_JADE,
     BODY_HUMAN, WEAP_STAFF, SHLD_NONE, HELM_HOOD, P_JADE, P_JADE, 1.02f, false, 0 }, {2,13,11,15},4 },
 { "Golem", 700, 28,3,10, 60,40, 200,80,80, 0,20, 200,270, 44,3,
   { {168,196,214,255},{110,140,164,255},{74,100,124,255},{200,226,240,255},{80,110,130,255},P_KI,
     BODY_BRUTE, WEAP_AXE, SHLD_NONE, HELM_NONE, P_KI, P_KI, 1.35f, false, 0 }, {2,2,3},3 },
 { "Ronin", 900, 10,13,20, 40,40, 1,0,0, 0,19, 120,120, 44,3,
   { {188,152,118,255},{70,74,86,255},{46,50,60,255},{160,140,90,255},{34,30,28,255},P_STEEL,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_NONE, P_STEEL, P_STEEL, 1.05f, false, 0 }, {2,13,11,15},4 },
 { "Ronin", 1000, 10,11,10, 40,40, 1,0,0, 0,20, 500,320, 44,3,
   { {188,152,118,255},{70,74,86,255},{46,50,60,255},{160,140,90,255},{34,30,28,255},P_STEEL,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_NONE, P_STEEL, P_STEEL, 1.05f, false, 0 }, {2,13,11,15},4 },
 { "Shaman", 1000, 9,8,8, 20,50, 1,0,0, 0,20, 500,320, 44,3,
   { {176,150,120,255},{86,70,52,255},{56,46,34,255},{120,160,110,255},{40,34,28,255},P_JADE,
     BODY_HUMAN, WEAP_STAFF, SHLD_NONE, HELM_HOOD, P_JADE, P_JADE, 1.02f, false, 0 }, {2,2,3},3 },
 { "Golem", 1000, 25,0,20, 50,30, 0,80,80, 0,27, 350,460, 44,3,
   { {168,196,214,255},{110,140,164,255},{74,100,124,255},{200,226,240,255},{80,110,130,255},P_KI,
     BODY_BRUTE, WEAP_AXE, SHLD_NONE, HELM_NONE, P_KI, P_KI, 1.35f, false, 0 }, {2,3,5},3 },
 { "Agent", 1000, 19,0,10, 40,-10, 0,90,90, 0,21, 120,140, 44,3,
   { {168,138,112,255},{40,42,54,255},{26,28,36,255},{140,44,44,255},{28,26,24,255},P_INK2,
     BODY_HUMAN, WEAP_KNIFE, SHLD_NONE, HELM_HOOD, P_INK2, P_INK2, 1.0f, false, 0 }, {2,2,3},3 },
 { "Shadow Reaper", 1000, 65,15,5, 85,85, 1,20,20, 0,60, 700,600, 44,3,
   { {110,100,130,255},{40,32,56,255},{24,18,36,255},{122,92,158,255},{20,16,28,255},P_VIOLET,
     BODY_WISP, WEAP_SCYTHE, SHLD_NONE, HELM_HOOD, P_VIOLET, P_VIOLET, 1.45f, true, 0 }, {2,2,3},3 },
 { "Samurai", 1100, 18,0,10, 40,30, 0,40,30, 0,18, 160,230, 52,4,
   { {190,156,120,255},{78,62,58,255},{50,40,38,255},{178,146,74,255},{34,30,28,255},P_GOLD,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_HORNED, P_GOLD, P_GOLD, 1.08f, false, 0 }, {2,2,3},3 },
 { "Mountain Naga", 1100, 25,4,30, 40,40, 400,20,20, 0,22, 200,265, 52,4,
   { {150,132,86,255},{122,104,62,255},{86,72,42,255},{190,170,110,255},{70,60,36,255},P_GOLD2,
     BODY_BEAST, WEAP_NONE, SHLD_NONE, HELM_NONE, P_GOLD2, P_GOLD2, 1.15f, false, 0 }, {2,3,5},3 },
 { "Mountain Naga", 1150, 17,10,0, 30,30, 450,30,30, 0,27, 350,460, 52,4,
   { {150,132,86,255},{122,104,62,255},{86,72,42,255},{190,170,110,255},{70,60,36,255},P_GOLD2,
     BODY_BEAST, WEAP_NONE, SHLD_NONE, HELM_NONE, P_GOLD2, P_GOLD2, 1.15f, false, 0 }, {2,2,3},3 },
 { "Undead", 1200, 28,0,7, 40,10, 1,20,20, 0,15, 180,225, 52,4,
   { {126,140,110,255},{84,80,64,255},{54,52,42,255},{110,124,96,255},{44,44,36,255},P_JADE,
     BODY_UNDEAD, WEAP_AXE, SHLD_NONE, HELM_NONE, P_JADE, P_JADE, 1.05f, false, 0 }, {2,2,3},3 },
 { "Samurai", 1350, 14,10,10, 40,30, 0,40,30, 0,17, 550,750, 52,4,
   { {190,156,120,255},{78,62,58,255},{50,40,38,255},{178,146,74,255},{34,30,28,255},P_GOLD,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_HORNED, P_GOLD, P_GOLD, 1.08f, false, 0 }, {2,2,3},3 },
 { "Samurai", 1350, 10,14,10, 40,30, 150,40,30, 0,17, 550,750, 52,4,
   { {190,156,120,255},{78,62,58,255},{50,40,38,255},{178,146,74,255},{34,30,28,255},P_GOLD,
     BODY_HUMAN, WEAP_BROAD, SHLD_NONE, HELM_HORNED, P_GOLD, P_GOLD, 1.08f, false, 0 }, {2,13,11,15},4 },
 { "Undead", 1500, 30,0,10, 60,20, 1,40,20, 0,17, 300,450, 52,4,
   { {126,140,110,255},{84,80,64,255},{54,52,42,255},{110,124,96,255},{44,44,36,255},P_JADE,
     BODY_UNDEAD, WEAP_AXE, SHLD_NONE, HELM_NONE, P_JADE, P_JADE, 1.05f, false, 0 }, {2,2,7,5},4 },
 { "Blood Spirit", 1800, 0,65,0, 0,65, 4000,20,50, 0,35, 400,300, 52,4,
   { {190,90,90,255},{120,40,52,255},{80,24,34,255},{220,120,110,255},{60,20,26,255},P_BLOOD,
     BODY_WISP, WEAP_NONE, SHLD_NONE, HELM_NONE, P_BLOOD, P_BLOOD, 1.0f, true, 0 }, {2,13,11,15},4 },
 { "Semi Demon", 2300, 25,10,10, 50,10, 200,30,30, 0,25, 300,300, 52,4,
   { {150,90,96,255},{80,40,60,255},{52,26,40,255},{190,80,70,255},{36,24,30,255},P_BLOOD,
     BODY_HUMAN, WEAP_BROAD, SHLD_NONE, HELM_HORNED, P_BLOOD, P_BLOOD, 1.15f, true, 0 }, {2,2,7,5},4 },
 { "Flesh Fiend", 2350, 30,10,10, 40,40, 350,60,60, 0,30, 500,500, 52,4,
   { {170,120,110,255},{124,70,64,255},{80,44,42,255},{200,150,140,255},{70,40,38,255},P_BLOOD,
     BODY_BRUTE, WEAP_BROAD, SHLD_NONE, HELM_NONE, P_BLOOD, P_BLOOD, 1.4f, false, 0 }, {2,2,7,5},4 },
 { "Liquid Metal", 3000, 60,0,10, 70,20, 350,30,30, 0,27, 300,300, 60,5,
   { {142,148,158,255},{86,92,104,255},{60,64,74,255},{190,196,206,255},{86,92,104,255},P_STEEL,
     BODY_BRUTE, WEAP_BROAD, SHLD_NONE, HELM_NONE, P_STEEL, P_STEEL, 1.2f, true, 0 }, {2,2,7,5},4 },
 { "Fallen Guardian", 4000, 50,20,10, 40,40, 2300,20,20, 0,38, 500,400, 60,5,
   { {160,150,140,255},{86,84,96,255},{56,54,64,255},{198,160,74,255},{40,40,44,255},P_GOLD,
     BODY_BRUTE, WEAP_BROAD, SHLD_NONE, HELM_FULL, P_GOLD, P_GOLD, 1.35f, false, 0 }, {2,2,7,5},4 },
 { "Anti Ninja", 4000, 65,15,5, 0,0, 1,20,20, 0,80, 600,500, 60,5,
   { {140,132,128,255},{36,34,44,255},{22,20,28,255},{150,40,40,255},{24,22,22,255},P_INK2,
     BODY_HUMAN, WEAP_KATANA, SHLD_NONE, HELM_HOOD, P_INK2, P_INK2, 1.05f, false, 0 }, {2,2,7,5},4 },
};
...
#include "weapon_art_table.h"

/* Which row of the original's weapon clip an item is, by name.  Returns -1
   for anything that is not one of its twenty-five weapons. */
int data_weapon_art(const char *name)
{
    if (!name) return 0;
    for (unsigned i = 1; i < sizeof WEAPON_ART / sizeof WEAPON_ART[0]; i++)
        if (!strcmp(WEAPON_ART[i].name, name)) return (int)i;
    return 0;
}

const WeaponArt *data_weapon_art_row(int idx)
{
    if (idx <= 0 || idx >= (int)(sizeof WEAPON_ART / sizeof WEAPON_ART[0])) return NULL;
    return &WEAPON_ART[idx];
}
