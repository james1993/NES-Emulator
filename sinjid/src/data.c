...
const SkillDef SKILLS[MAX_SKILLS] = {
 { "Strike", "A plain swing. Costs nothing and never runs dry.",
   0, 10, 0, { -1, -1 },  0,  0, 1.00f, 0.00f, DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_NONE, ANIM_ATTACK, P_STEEL },
 { "Guard", "Brace. Halves damage taken this round and mends shield points.",
   0, 10, 0, { -1, -1 },  0,  0, 0.00f, 0.00f, DMG_PHYSICAL, SK_TARGET_SELF, SKF_SHIELD_UP, ANIM_BLOCK, P_KI },
 { "Double Cut", "Two fast strikes at reduced power each.",
   0, 10, 0, { -1, -1 },  0, 14, 0.60f, 0.07f, DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_MULTI, ANIM_ATTACK, P_STEEL },
 { "Shield Breaker", "Heavy overhead. Triple damage to shield points.",
   0, 10, 0, { -1, -1 },  0, 18, 0.90f, 0.12f, DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_SHIELD_DMG, ANIM_ATTACK, P_GOLD },
 { "Gut Thrust", "Slips inside the guard. Ignores shield points entirely.",
   0, 10, 0, { 1, -1 },  0, 26, 0.75f, 0.10f, DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_IGNORE_SHD, ANIM_ATTACK, P_BLOOD },
 { "Wide Sweep", "One arc across every enemy still standing.",
   0, 10, 0, { 1, -1 },  0, 30, 0.55f, 0.08f, DMG_PHYSICAL, SK_TARGET_ALL_FOES, SKF_NONE, ANIM_ATTACK, P_STEEL },
 { "Iron Stance", "Physical defence sharply raised for three rounds.",
   0, 10, 1, { 2, -1 },  0, 20, 0.00f, 0.00f, DMG_PHYSICAL, SK_TARGET_SELF, SKF_BUFF_DEF, ANIM_BLOCK, P_STEEL },
 { "Bloodletter", "A deep cut that returns a third of the damage as life.",
   0, 10, 1, { 3, -1 }, 0, 34, 0.85f, 0.11f, DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_DRAIN, ANIM_ATTACK, P_BLOOD },
 { "Hilt Smash", "Cracks the skull. May stun for a round.",
   0, 10, 1, { 4, -1 }, 0, 28, 0.60f, 0.09f, DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_STUN, ANIM_ATTACK, P_GOLD },
 { "Killing Breath", "Everything you have, in one downward cut.",
   0, 10, 1, { 4, -1 }, 0, 48, 1.80f, 0.22f, DMG_PHYSICAL, SK_TARGET_ONE_FOE, SKF_SHIELD_DMG|SKF_NEVER_MISS, ANIM_ATTACK, P_BLOOD2 },

 { "Ki Bolt", "A thrown spark of ki. Cheap and reliable.",
   1, 10, 5, { 6, -1 },  6,  0, 1.00f, 0.14f, DMG_MAGIC, SK_TARGET_ONE_FOE, SKF_NONE, ANIM_CAST, P_KI },
 { "Mend", "Knit your own wounds shut.",
   1, 10, 5, { 8, -1 },  12, 0, 0.00f, 0.00f, DMG_MAGIC, SK_TARGET_SELF, SKF_HEAL, ANIM_HEAL, P_JADE },
 { "Frost Nail", "A cold spike that bypasses the shield layer.",
   1, 10, 5, { 9, -1 },  16, 0, 1.10f, 0.16f, DMG_MAGIC, SK_TARGET_ONE_FOE, SKF_IGNORE_SHD, ANIM_CAST, P_KI2 },
 { "Ember Wave", "Fire washes over the whole line.",
   1, 10, 10, { 10, -1 },  26, 0, 0.70f, 0.11f, DMG_MAGIC, SK_TARGET_ALL_FOES, SKF_NONE, ANIM_CAST, P_BLOOD2 },
 { "Ward", "Wrap yourself in ki. Magic defence up for three rounds.",
   1, 10, 10, { 10, -1 },  18, 0, 0.00f, 0.00f, DMG_MAGIC, SK_TARGET_SELF, SKF_BUFF_DEF, ANIM_HEAL, P_VIOLET },
 { "Drain Soul", "Pull life across the gap and keep half of it.",
   1, 10, 10, { 7, 11 }, 30, 0, 0.95f, 0.13f, DMG_MAGIC, SK_TARGET_ONE_FOE, SKF_DRAIN|SKF_IGNORE_SHD, ANIM_CAST, P_VIOLET },
 { "Focus", "Breathe. Restores mana and sharpens the next blows.",
   1, 10, 10, { 5, 12 },  0,  0, 0.00f, 0.00f, DMG_MAGIC, SK_TARGET_SELF, SKF_RESTORE_MP|SKF_BUFF_ATK, ANIM_HEAL, P_GOLD },
 { "Chain Lightning", "Splits across every enemy and never misses.",
   1, 10, 15, { 13, 14 }, 44, 0, 1.05f, 0.15f, DMG_MAGIC, SK_TARGET_ALL_FOES, SKF_NEVER_MISS, ANIM_CAST, P_KI2 },
 { "Shadow Rend", "Tears the shape out from under them. Pure damage.",
   1, 10, 15, { 15, -1 }, 60, 10, 1.90f, 0.25f, DMG_PURE, SK_TARGET_ONE_FOE, SKF_IGNORE_SHD|SKF_NEVER_MISS, ANIM_CAST, P_VIOLET },
};
